...
<div class="min-h-screen bg-background">
  <div class="max-w-7xl mx-auto p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4 sm:pb-6 gap-4 ml-14 sm:ml-0">
      <div>
        <h1 class="text-2xl sm:text-3xl font-semibold tracking-tight">登録済み商品</h1>
      ...
      {:else}
        {#each currentRecipes as recipe}
          <Card>
            ...
            <CardContent>
              <div class="space-y-2">
                <p class="text-sm font-medium text-muted-foreground">原材料:</p>
          ...
          <div>
            ...
            <div class="space-y-2">
              {#if currentIngredients.length === 0}
                <div class="text-sm text-muted-foreground p-4 bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded-md">
              ...
              {:else if modalFormData.ingredients.length === 0}
                <p class="text-sm text-muted-foreground">原材料を追加してください。</p>
              {:else}
                {#each modalFormData.ingredients as ingredient, index}
                  ...
                  <div class="grid grid-cols-12 gap-2 items-center">
                    ...
                    <input
                      ...
                      placeholder="使用量"
                      required
                      class="col-span-3 px-3 py-2 border border-input rounded-md bg-background"
                    />
