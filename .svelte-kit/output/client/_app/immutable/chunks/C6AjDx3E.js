import{K as M,L as c,M as S,h as k,u as x,r as g,k as u}from"./CKfg2sLP.js";import{c as m,a as $}from"./BtMTq5ME.js";import{I as h,s as _}from"./OEQlJTPW.js";import{l as y,s as b}from"./D-TBqR7l.js";function q(e,a,n=a){var o=new WeakSet;M(e,"input",async l=>{var r=l?e.defaultValue:e.value;if(r=v(e)?f(r):r,n(r),c!==null&&o.add(c),await S(),r!==(r=a())){var s=e.selectionStart,t=e.selectionEnd,i=e.value.length;if(e.value=r??"",t!==null){var d=e.value.length;s===t&&t===i&&d>i?(e.selectionStart=d,e.selectionEnd=d):(e.selectionStart=s,e.selectionEnd=Math.min(t,d))}}}),(k&&e.defaultValue!==e.value||x(a)==null&&e.value)&&(n(v(e)?f(e.value):e.value),c!==null&&o.add(c)),g(()=>{var l=a();if(e===document.activeElement){var r=c;if(o.has(r))return}v(e)&&l===f(e.value)||e.type==="date"&&!l&&!e.value||l!==e.value&&(e.value=l??"")})}function v(e){var a=e.type;return a==="number"||a==="range"}function f(e){return e===""?null:+e}function H(e,a){const n=y(a,["children","$$slots","$$events","$$legacy"]);/**
